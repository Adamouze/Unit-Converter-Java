		...
		switch (type)
		{
			...
			case SPEED:
				...
				set.add(getDerivedNumericUnit(MeasureType.SPEED,
						                          ...
						                          0.0,
						                          OperationOrder.FACTOR_ONLY));
				Unit<Double> ms = getDerivedNumericUnit(MeasureType.SPEED,
												  "Minutes / Kilomètre",
												  "km/h",
												  "5.6",
												  -1.0,
												  ...
												  OperationOrder.FACTOR_ONLY);
				set.add(ms);
				set.add(getDecomposedUnit(ms,"Minutes:Secondes / Kilomètre","m:s/km",":",new Double[] {1.,60.}));
				set.add(getDerivedNumericUnit(MeasureType.SPEED,
				                        		  "Minutes / Mille",
				                        		  "min/mi",
				                        		  "5.6",
			...
			case DIRECTION:
				set.add(getBoundedBaseNumericUnit(MeasureType.DIRECTION,
				                                  ...
				                                  "",
				                                  "9.4"));
				Unit<Double> deg = getDerivedNumericUnit(MeasureType.DIRECTION,
						                          "Degrés",
						                          "°",
						                          "4.1",
						                          0.0,
						                          ...
						                          OperationOrder.FACTOR_ONLY);
 				set.add(deg);
 				set.add(getDecomposedUnit(deg, "Degrés,minutes,secondes", "°,',''", ",", new Double[] {1.,60.,60.}));
			...
			case TIME:
			{
				...
				Unit<Double> minutes = getDerivedNumericUnit(MeasureType.TIME,
						                          ...
						                          OperationOrder.FACTOR_ONLY);
				set.add(minutes);
				Unit<Double> heures =getDerivedNumericUnit(MeasureType.TIME,
                        					      "Heures",
                        					      "h",
                        					      "8.5",
                        					      1.0,
				...
				set.add(getDecomposedUnit(heures, "heure:minute:seconde", "h:m:s", ":", new Double[] {1.,60.,60.}));
				break;
			}
			default:
				break;
