...
//		System.out.println(this + " Setting value = " + this.value.get());
	...
	{
		// DONE Complete Unit::convertValueTo(Unit<?> unit) using unit's convertValueFrom
		if (!hasValue())
		{
			throw new IllegalStateException("this unit has no value");
		}
